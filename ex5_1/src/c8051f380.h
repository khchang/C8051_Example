...
sfr16 TMR3RL    = 0x92;          /* Timer 3 reload register                  */
sfr16 TMR4RL    = 0x92;          /* Timer 4 reload register         (page F) */
sfr16 TMR3      = 0x94;          /* Timer 3 register                         */
sfr16 TMR4      = 0x94;          /* Timer 4 register                (page F) */
sfr16 SBRL1     = 0xB4;          /* UART1 Baud Rate Generator                */
sfr16 ADC0      = 0xBD;          /* ADC 0 data                               */
sfr16 ADC0GT    = 0xC3;          /* ADC 0 greater than compare               */
sfr16 ADC0LT    = 0xC5;          /* ADC 0 less than compare                  */
sfr16 TMR2RL    = 0xCA;          /* Timer\Counter 2 reload data              */
sfr16 TMR5RL    = 0xCA;          /* Timer\Counter 5 reload data     (page F) */
sfr16 TMR2      = 0xCC;          /* Timer\Counter 2 data                     */
sfr16 TMR5      = 0xCC;          /* Timer\Counter 5 data                     */
sfr16 PCA0CP1   = 0xE9;          /* PCA module 1 capture/compare data        */
sfr16 PCA0CP2   = 0xEB;          /* PCA module 2 capture/compare data        */
sfr16 PCA0CP3   = 0xED;          /* PCA module 3 capture/compare data        */
sfr16 PCA0      = 0xF9;          /* PCA 0 counter data                       */
sfr16 PCA0CP0   = 0xFB;          /* PCA 0 capture data                       */
sfr16 PCA0CP4   = 0xFD;          /* PCA 4 capture data                       */
